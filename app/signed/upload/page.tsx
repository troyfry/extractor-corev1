          ...
          {!hasKey && (
            <div className="mb-4 bg-yellow-900/20 border border-yellow-700 rounded-lg p-4 flex items-start gap-3">
              ...
              <div className="flex-1">
                <p className="font-medium text-yellow-200 mb-1">OpenAI API Key Required</p>
                <p className="text-sm text-yellow-300 mb-3">
                  Add your OpenAI API key to enable AI-powered extraction for better accuracy when processing signed work orders.
                </p>
                <Link
                ...
                <div className="flex items-center gap-4 pt-2 border-t border-gray-700">
                  <div>
                    ...
                    <span className={`ml-2 px-2 py-0.5 rounded text-xs font-medium ${
                      ...
                      {result.data.extraction.method?.replace("_", " ") || "Unknown"}
                    </span>
                  </div>
                  <div>
                    <span className="text-xs text-gray-400">Confidence:</span>
